...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-haplo.stats-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-haplo.stats-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-haplo.stats
# for installing globally
pixi global install r-haplo.stats
```
...
It is possible to list all of the versions of `r-haplo.stats` available on your platform:
...
```
pixi search r-haplo.stats --channel conda-forge
```
